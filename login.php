...
$error = '';
$alertaLogin = $_SESSION['alerta_login'] ?? null;
            ...
            <div class="form-container">
                ...
                <form id="loginForm" method="POST" action="login.php" novalidate>
                    ...
                    <?php if (!empty($alertaLogin)): ?>
                        <div style="background: rgba(47,224,176,0.12); border: 1px solid rgba(47,224,176,0.3); border-radius: 10px; color: #9CE9CF; padding: 12px 16px; font-size: 0.9rem; margin-bottom: 20px; display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="form-options">
                        ...
                        <a href="<?= BASE_URL ?>/recuperar-password.php" class="forgot-link">¿Olvidaste tu contraseña?</a>
                    </div>
